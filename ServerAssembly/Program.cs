...
namespace Florence.ServerAssembly
{
    ...
    {
        static public List<nint> clientsToSendTo = new List<nint>(1);
        ...
        static void Main()
        {
            ...
            Valve.Sockets.Native.GameNetworkingSockets_Init(Florence.ServerAssembly.Networking.Get_NetworkIdentity(), new StringBuilder(1024));
